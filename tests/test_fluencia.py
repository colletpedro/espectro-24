...
def _output_com_distribuicao():
    # v1.9.0: shares 3/17/79 a partir de histograma SINTÉTICO — a marcação de
    # perspectiva depende do share, não da fronteira (ver conftest).
    from conftest import CONTAGENS_3_17_79, histograma_de_contagens
    buckets = [_bucket("negativas", 40), _bucket("medianas", 40), _bucket("positivas", 40)]
